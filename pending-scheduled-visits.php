...
$sql = "SELECT visits.*, properties.title AS title, properties.property_description AS property_description, properties.price AS price, properties.property_image AS property_image  FROM visits JOIN properties ON visits.property = properties.id WHERE status='pending' ORDER BY visits.reg_date DESC ";
    ...
    <div class="position-relative">
        ...
        <div class="position-relative">
            ...
            <div class="container pt-5">
                <div class="container display-4">Pending Scheduled Visits</div>
            </div>
            <!-- end search section -->
